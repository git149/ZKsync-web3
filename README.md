...
> **Author:** [git149](https://github.com/git149)  
> **Repository:** [Ts-Tsender-UI](https://github.com/git149/Ts-Tsender-UI)  
> **Created:** 2025  
> **License:** MIT

A 100% client-side UI for the TSender contract.

Smart Contracts:git clone git@github.com:git149/Ts-Tsender-UI.git
...
```bash
git clone git@github.com:git149/Ts-Tsender-UI.git
cd tsender-ui
pnpm install
pnpm anvil
```
